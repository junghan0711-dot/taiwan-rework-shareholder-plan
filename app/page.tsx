...
const months = [
  { label: '10月', cash: 3560, phase: '建置' },
  { label: '11月', cash: 3327, phase: '建置' },
  { label: '12月', cash: 3093, phase: '建置' },
  { label: '1月', cash: 2927, phase: '營運' },
  { label: '2月', cash: 2783, phase: '營運' },
  { label: '3月', cash: 2648, phase: '營運' },
  { label: '4月', cash: 2594, phase: '課程' },
  { label: '5月', cash: 2480, phase: '營運' },
  { label: '6月', cash: 2375, phase: '營運' },
  { label: '7月', cash: 2351, phase: '課程' },
  { label: '8月', cash: 2279, phase: '營運' },
  { label: '9月', cash: 2216, phase: '營運' },
];
...
const units = [
  ...
  { code: 'C04', name: '課程教學', revenue: '20萬', cost: '86萬', result: '-66萬', tone: 'negative' },
];
...
const costDetails = [
  ...
  { group: '建置投入', item: '食農教育場域及廁所80萬＋堆肥設備與建構50萬＋園區安全建置10萬', timing: '建置期', amount: '140萬元' },
    ...
    <main>
      ...
      <section className="section" id="overview">
        ...
        <article className="cash-panel">
          <div className="panel-copy">
            ...
            <h3>建置後仍保有<br /><em>21.6 個月</em>資金支應能力</h3>
            <p>依目前模型，2027 年 9 月期末現金為 221.6 萬元，仍高於 200 萬元最低保留額。</p>
            <div className="reserve-key"><i />最低保留額 200 萬元</div>
          </div>

          <div className="cash-chart" role="img" aria-label="2026年10月至2027年9月期末現金逐月下降，由356萬元降至221.6萬元">
        ...
        <div className="detail-shell">
          ...
          <div className="detail-grid">
            ...
            <article className="detail-card cost-card">
              <div className="detail-card-head">
                <span>成本支出</span><strong>462.4萬元</strong>
              </div>
              {costDetails.map((row) => (
              ...
              <p className="detail-footnote">以上金額合計約 462.4 萬元；四捨五入可能產生尾差。</p>
            </article>
          </div>
        </div>
      </section>
      ...
      <section className="decision-section">
        ...
        <div className="decision-list">
          ...
          <p><span>02</span><span>期末現金僅高於安全線 <b>21.6 萬元</b>，仍需嚴格控管支出。</span></p>
